  ...
  <div>
    <section class="section">
      <div class="container has-text-left">
        <h2 class="is-size-2">クリニックのご紹介---患者様・ご家族と話し合い、心のこもったオーダーメイドの在宅医療を提供します。</h2>
        <h3 class="is-size-3">医師・ケアマネージャー・訪問看護師との連携で、在宅療養の環境を整備します。</h3>
        ...
        <h3 class="is-size-3">24時間、365日の医学的サポートをいたします</h3>
        ...
        <h3 class="is-size-3">訪問診療の費用は保険でカバー</h3>
